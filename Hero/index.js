...
const Hero = () => {
    return (
        <div className='md:grid md:grid-cols-2'> 
            <div className='md:mt-16 m-2 lg:ml-20'>
                <h1 className="text-xl uppercase leading-none md:text-2xl">Olá, eu sou o Philippe Berto</h1>
                <h3 className="font-bold text-xl uppercase leading-none md:text-2xl sm:text-2xl">Fullstack Developer</h3>
            ...
            <div className='w-1/2 flex items-start -mt-16 md:mt-0'>
